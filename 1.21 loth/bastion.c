...
int get_stables_loot(const uint64_t seed, Pos* pos1, Pos* pos2, Pos* pos3, int* loot, int one, int two, int three) {
    Xoroshiro xr;
    uint64_t rand;
    uint64_t decorator_seed;
    uint64_t loot_seed;
...
int get_stables_double_triple_loot(const uint64_t seed, Pos* pos1, Pos* pos2, int* loot, int one, int two) {
	Xoroshiro xr;
	uint64_t rand;
	uint64_t decorator_seed;
	uint64_t loot_seed;
